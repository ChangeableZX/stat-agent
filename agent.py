...
TOOLS = [
    _tool(
        "make_analysis_plan",
        "Initialize the central StatPlan. Supports two-group, multi-group, correlation, and categorical intents.",
        {
            "research_question": {"type": "string"},
            "intent": {
                "type": "string",
                "enum": ["compare_two_groups", "compare_multi_groups", "correlation", "categorical_test"],
            },
